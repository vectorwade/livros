...
void Dados_Do_Usuario(struct Cadastro Pessoa[quant_pes], int *cont_pessoas, int *num_matricula, int *quant_Usuario)
{
...
void exibe( struct Cadastro Pessoa[quant_pes], int *cont_pessoas)
{
...
void excluir(struct Cadastro Pessoa[quant_pes], int *cont_pessoas, struct Base base)
{
    char Idenficacao[15];
    int Tamanho_String;
...
void main_pessoas(int *cont_pessoas, int *cont_cadastro)
{
    ...
    while(Opcao != 5)
    {
        ...
        case 1://Cadastrar pessoa
            Dados_Do_Usuario(Pessoa, cont_pessoas, &num_matricula, &quant_Usuario);//
            getchar();
            (*cont_pessoas)++;
            break;

        case 2://Exibir dados de todas as pessoas
            exibe(Pessoa, cont_pessoas);
            break;

        case 3://Altera os Dados de Algum Usuario
            Altera_Dados_De_Uma_Pessoa(Pessoa, cont_pessoas);
            break;

        case 4://Excluir um usuario
            excluir(Pessoa, cont_pessoas, base);
            break;
